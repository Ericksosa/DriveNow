...
<div class="space-y-2 flex-grow">
    ...
    <div>
        ...
        <div class="relative mt-2 rounded-md shadow-sm">
            <input type="text" value="{{ old('name', isset($vehicleType) ? $vehicleType->name : '') }}" name="name"
                id="name"
    ...
    <textarea id="description" name="description" rows="2"
        ...
        placeholder="{{ __('Escribe la descripcion de los tipos vehículos...') }}">{{ old('description', isset($vehicleType) ? $vehicleType->description : '') }}</textarea>
