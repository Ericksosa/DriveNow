            ...
            <div class="p-6 flex justify-between items-center">
                <div>
                    <h3 class="text-lg font-semibold text-gray-800 dark:text-gray-200">
                        {{ __('Tabla Gestión de Marcas') }}
                    </h3>
                    <p class="text-gray-600 dark:text-gray-400">
                        {{ __('Aqui puedes gestionar las marcas. Crear, Editar y Eliminar') }}</p>
                </div>
                <div class="flex relative">
                    ...
                    <a href="{{ route('brand.export') }}" id="export_button"
                    ...
                    <a href="{{ route('brand.export.pdf') }}" id="export_button"
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm">
                                    ...
                                    <form method="POST"
                                        ...
                                        <button type="submit" class="px-4 py-2 text-red-500 hover:text-red-700"
                                            data-confirm="¿Estás seguro de que deseas eliminar la marca {{ $brand->name }}?">
                                            {{ __('Eliminar') }}
                                        </button>
                                    </form>
                                </td>
                    ...
                    @empty
                        <tr>
                            <td class="px-6 py-4 whitespace-nowrap text-gray-800 dark:text-gray-400" colspan="10">
                                {{ __('No hay registros de marcas. Crea uno ahora.') }}
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
